...
import static org.apache.skywalking.oap.server.core.source.DefaultScopeDefine.SERVICE_EVENT;
...
@ScopeDeclaration(id = SERVICE_EVENT, name = "ServiceEvent", catalog = SERVICE_CATALOG_NAME)
@ScopeDefaultColumn.VirtualColumnDefinition(fieldName = "entityId", columnName = "entity_id", isID = true, type = String.class)
@Stream(name = Event.INDEX_NAME, scopeId = SERVICE_EVENT, builder = ServiceEvent.Builder.class, processor = MetricsStreamProcessor.class)
...
public class ServiceEvent extends Event {
    ...
    public String getEntityId() {
        return IDManager.ServiceID.buildId(getService(), true);
    }

    public static class Builder implements StorageBuilder<ServiceEvent> {
        @Override
        public ServiceEvent storage2Entity(final Convert2Entity converter) {
        ...
        @Override
        public void entity2Storage(final ServiceEvent storageData, final Convert2Storage converter) {
