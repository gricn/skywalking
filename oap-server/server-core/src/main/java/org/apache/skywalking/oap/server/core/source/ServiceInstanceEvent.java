...
import static org.apache.skywalking.oap.server.core.source.DefaultScopeDefine.SERVICE_INSTANCE_EVENT;
...
@ScopeDeclaration(id = SERVICE_INSTANCE_EVENT, name = "ServiceInstanceEvent", catalog = SERVICE_INSTANCE_CATALOG_NAME)
@ScopeDefaultColumn.VirtualColumnDefinition(fieldName = "entityId", columnName = "entity_id", isID = true, type = String.class)
@Stream(name = Event.INDEX_NAME, scopeId = SERVICE_INSTANCE_EVENT, builder = ServiceInstanceEvent.Builder.class, processor = MetricsStreamProcessor.class)
@MetricsExtension(supportDownSampling = false, supportUpdate = true)
public class ServiceInstanceEvent extends Event {

    @Override
    public MetricsMetaInfo getMeta() {
        int scope = DefaultScopeDefine.SERVICE_INSTANCE;
    ...
    public String getEntityId() {
        ...
        String id = IDManager.ServiceInstanceID.buildId(serviceId, getServiceInstance());
        return id;
    }

    public static class Builder implements StorageBuilder<ServiceInstanceEvent> {
        @Override
        public ServiceInstanceEvent storage2Entity(final Convert2Entity converter) {
            ServiceInstanceEvent record = new ServiceInstanceEvent();
        ...
        @Override
        public void entity2Storage(final ServiceInstanceEvent storageData, final Convert2Storage converter) {
